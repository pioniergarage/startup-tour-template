...
$AboutTourText = "13 students from the PionierGarage, the university group for entrepreneurship at the Karlsruhe Institute of Technology (KIT) in Germany, are going visit one of the world's most significant tech and startup regions: Boston and New York.
To find out more about our entrepreneurship club at Germany's leading technical university, head over to our homepage or contact us on vorstand@pioniergarage.de to become part of the tour as a supporter, partner, sponsor or Startup/VC to be visited. We're looking forward to meeting inspiring people!";

//Text next to the PG Logo
$AboutThePGText = "The Pioneers are heading to the US again! After three inspiring tours to the Sillicon Valley, the PionierGarage is visiting Boston and New York from December 3rd - December 13th. In 2014 again, we are full of energy to come back with a new group of young (aspiring) entrepreneurs. During the 10-day tour, we are visiting a number of startups, venture capitalists, entrepreneurial organisations and educational institutions.";
...
$TeamMember[] = array('Name' => "David Schmidt",
                      'ImgName' => "david.jpg",
                      'Studies' => "Industrial Egnineering",
...
$Sponsors[] = array('ImgName' => "dsclogo.jpg");
